...
if len(sys.argv) not in [4, 5]:
    print("Usage: {} <font file> <font size in pixels> <output path> [flags]".format(sys.argv[0]), file=sys.stderr)
    print("       where flags is a combination of:", file=sys.stderr)
    print("          c -- compressed", file=sys.stderr)
    exit(1)
else:
