...
set(MWATCH_TOOLCHAIN_COMMON_FLAGS "--target=arm-none-eabif -ftls-model=local-exec -mfloat-abi=hard -march=armv7em -mcpu=cortex-m4 -mfpu=fpv4-sp-d16 --sysroot ${MWATCH_TOOLCHAIN_SYSROOT}")
