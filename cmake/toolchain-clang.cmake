...
set(OBJCOPY_EXECUTABLE ${MWATCH_TOOLCHAIN_DIR}/llvm-objcopy)

set(CMAKE_TRY_COMPILE_TARGET_TYPE "STATIC_LIBRARY")

# we always build with debug info because of the crash handler
set(CMAKE_C_FLAGS_INIT "-nostdlib -mthumb -ggdb3")
set(CMAKE_CXX_FLAGS_INIT "-nostdlib -mthumb -fno-exceptions -fno-rtti -Wno-register -ggdb3")
